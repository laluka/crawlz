	...
	go func() {
		...
		for s.Scan() {
			...
			c := colly.NewCollector(
				...
				colly.UserAgent("User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) snap Chromium/83.0.4103.106 Chrome/83.0.4103.106 Safari/537.36"),
				// set custom headers
